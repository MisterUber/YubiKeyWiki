...
![U2F Schematic]({{ site.baseurl }}{{ page.dir }}img/u2f_schematic.png)  
...
![U2F Ablauf]({{ site.baseurl }}{{ page.dir }}img/u2f_ablauf.png)  
...
![FIDO2 Protocol Stack]({{ site.baseurl }}{{ page.dir }}img/fido2_protocol_stack.png)
...
![FIDO2 Ablauf]({{ site.baseurl }}{{ page.dir }}img/fido2_ablauf.png)  
